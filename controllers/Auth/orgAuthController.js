...
const { sendPasswordChangedConfirmation, sendResetPasswordURL } = require('../../admin/email/organization');
dotenv.config();
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    await sendResetPasswordURL(organization.email, 'Reset your password (valid for 10 minutes)', resetURL);
